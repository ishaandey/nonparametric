...
2. Are the samples independently drawn from each other?
3. Are the population distributions normal, OR, are there more than 40 observations per sample?
4. Are my population variances equal?
...
If we're interested in generating a confidence interval for the difference, we can use the **Mann-Whitney** test. It works similarly to the Wilcoxon Rank-Sum, and results in the same p-value.
