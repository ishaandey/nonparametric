...
**Cumulative Distribution Function (CDF)**. $F_x(x)$ describes the *probability* of seeing a value less than or equal to $x$. In other words, $F_x(x) = \int_{-\infty}^{x}f_t(t)dt=Pr(X\leq x)$. More visually:
